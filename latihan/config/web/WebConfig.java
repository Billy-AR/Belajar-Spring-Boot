package com.backend.latihan.config.web;
...
public class WebConfig implements WebMvcConfigurer {
    ...
    public void configurePathMatch(PathMatchConfigurer configurer) {
        configurer.addPathPrefix("/api/latihan", PredicateParam -> true);
    }
    ...
    public void configureApiVersioning(ApiVersionConfigurer configurer) {
        configurer.useMediaTypeParameter(MediaType.parseMediaType("application/vnd.myapp+json"), "v").addSupportedVersions("1.0.0","2.0.0","3.0.0").setDefaultVersion("1.0.0");
    }
