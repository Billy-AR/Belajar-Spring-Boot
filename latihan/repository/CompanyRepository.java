...
public interface CompanyRepository extends JpaRepository<Company, Long> {
   ...
   List<Company> fetchCompaniesWithJobsByStatus(@Param("status") String status);
    ...
    List<Company> findAllWithJobsStatusNative(String status);
    ...
    int updateCompanyDetails(@Param("id") Long id, @Param("name") String name, @Param("logo") String logo, @Param("industry") String industry,
                             @Param("size") String size, @Param("rating") BigDecimal rating,
